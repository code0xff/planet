...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/code0xff/planet/blog/post
   */
  queryPostAll = (
    query?: {
    ...
    this.request<BlogQueryAllPostResponse, RpcStatus>({
      path: `/code0xff/planet/blog/post`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/code0xff/planet/blog/sentPost
   */
  querySentPostAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<BlogQueryAllSentPostResponse, RpcStatus>({
      path: `/code0xff/planet/blog/sentPost`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/code0xff/planet/blog/timedoutPost
   */
  queryTimedoutPostAll = (
    ...
    this.request<BlogQueryAllTimedoutPostResponse, RpcStatus>({
      path: `/code0xff/planet/blog/timedoutPost`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
